...
namespace GeometryElements
{
    public static class Operations
    {
        ...
        /// référentiel d'origine dont on connait le centre dans un autre référentiel de destination.</summary>
    ...
    {
        public static List<Point3D> MoveRotateCopy(this List<Point3D> points, Point3D dpt, Point3D angles)
        {
        ...
        public static List<Point3D> MoveRotateCopy(this List<Point3D> points, Point3D dpt, Point3D angles, Point3D centerPosition)
        {
            List<Point3D> newPoints = new List<Point3D>();
            foreach (Point3D point in points)
            {
        ...
        public static void Move(this List<Point3D> list, Point3D dpt) => list.Move(dpt.X, dpt.Y, dpt.Z);
        public static void Move(this List<Point3D> list, double dx, double dy, double dz)
        {
        ...
        public static List<Element> Copy(this List<Element> source)
        {
            List<Element> dest = new List<Element>();
        ...
        public static void CopyTo(this List<Element> source, List<Element> dest)
        {
            dest.Clear();
            foreach (Element element in source)
                dest.Add(element.Copy());
        ...
        public static List<Point3D> GetPoints(this Segment s, double pixelSize)
        {
            int x0 = (int) (s.A.X / pixelSize), y0 = (int) (s.A.Y / pixelSize);
            int x1 = (int) (s.B.X / pixelSize), y1 = (int) (s.B.Y / pixelSize);
            List<Point3D> pts = Operations.GetPointListFromSegment(x0, y0, x1, y1);
